     ...
     <div class="loginbox">
         ...
         <form action="login.php" method ="post" id="login" class="vert-align">
             <div class="form-group row">
                 ...
                 <input type="text" id="user" name="user" placeholder="admin" class="width-log" required>
             </div>
             <div class="form-group row">
                 <div  class="col-lg-4 col-sm-4 col-4">
                     <label for="pass">Mot de passe :</label>      
                 </div>
             <input type="password" id="password" name="password" placeholder="admin" class="width-log" required> 
            </div>
